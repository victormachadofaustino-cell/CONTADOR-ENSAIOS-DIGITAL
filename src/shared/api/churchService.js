...
import { DEFAULT_INSTRUMENTS } from "../config/config.js";
...
export const churchService = {
  ...
  createChurch: async ({
    ...
    try {
      ...
      await batch.commit();
      toast.success("Localidade e Orquestra configuradas!", {
        id: loadingToast,
      });
      return true;
    } catch (e) {
  ...
  updateMinistryMember: async (comumId, memberId, data) => {
    if (!comumId || !memberId)
      throw new Error("IDs ausentes para atualização.");
    try {

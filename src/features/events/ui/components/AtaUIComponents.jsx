    ...
    >
      <div className="flex items-center gap-4 text-slate-950">
        ...
        <div className="text-left leading-none">
          <h3 className="font-[900] italic uppercase text-sm tracking-tight">
            {title}
          </h3>
          {badge && (
...
export const Modal = ({
  ...
  <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[300] flex items-center justify-center p-6 text-left">
    ...
    >
      <div
        className={`w-20 h-20 mx-auto mb-8 rounded-full flex items-center justify-center shadow-inner ${

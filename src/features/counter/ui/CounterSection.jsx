...
const CounterSection = ({
  ...
  let sectionTotal = allInstruments // Explicação: Calcula o número total que aparece na barra preta do grupo.
  ...
  const handleToggleDeducao = async () => {
    if (!currentEventId || !comumId) return;
    try {
      await eventService.saveAtaData(comumId, currentEventId, {
        ...ataData,

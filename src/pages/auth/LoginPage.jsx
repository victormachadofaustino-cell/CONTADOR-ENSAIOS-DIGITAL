        ...
        <div className="bg-white rounded-[2.5rem] p-8 shadow-2xl border border-white/20 relative overflow-hidden">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            {authMode === 'register' && (
              <div className="space-y-4 animate-in slide-in-from-top-2">
                <div className="space-y-1.5">
                  ...
                  <input className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-5 text-xs font-black text-slate-950 outline-none uppercase" type="text" value={userName} onChange={e => setUserName(e.target.value)} required />
                </div>
            ...
            <div className="space-y-1.5">
              ...
              <input className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-5 text-xs font-black text-slate-950 outline-none" type="email" value={email} onChange={e => setEmail(e.target.value)} required />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-5 text-xs font-black text-slate-950 outline-none" type="password" value={pass} onChange={e => setPass(e.target.value)} required />
            </div>
